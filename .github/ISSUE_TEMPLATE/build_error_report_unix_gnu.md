---
name: Build error report (Unix: GNU/Linux)
about: Report a problem with compiling POV-Ray for Unix that is probably-specific to GNU/Linux
title: "[BUILD][UNIX] "
labels: compatibility?, OS: Unix, OS: Linux
assignees: ''
...
**Build Environment**
  - Operating system: [e.g. Ubuntu 16.04.3 LTS]
  - Hardware architecture: [e.g. x86, x86-64, armv8]
  - Compiler: [e.g. g++ 5.4.0]
