---
name: Build error report (Unix: BSD)
about: Report a problem with compiling POV-Ray for Unix that is probably specific to BSD-style unix variants
title: "[BUILD][UNIX] "
labels: compatibility?, OS: Unix, OS: BSD
assignees: ''
