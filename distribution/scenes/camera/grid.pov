...
#declare C1= camera { fisheye location <1,4,3> right    x*image_width/image_height angle 360 look_at <0,1,2> }
#declare C2= camera { fisheye_orthographic location <1,4,3> right    x*image_width/image_height angle 360 look_at <0,1,2> }
#declare C3= camera { fisheye_equisolid_angle location <1,4,3> right    x*image_width/image_height angle 360 look_at <0,1,2> }
#declare C4= camera { fisheye_stereographic location <1,4,3> right    x*image_width/image_height angle 360 look_at <0,1,2> }
camera { grid <2,2> C1 C2 C3 C4 }
