...
const INTERSECTION_STATS_INFO intersection_stats[kPOVList_Stat_Last] =
{
    ...
    { kPOVList_Stat_FractalTest,        Ray_Fractal_Tests, Ray_Fractal_Tests_Succeeded,
      "Fractal" },
    { kPOVList_Stat_GSDIntermergeTest,  Ray_GSD_Intermerge_Tests, Ray_GSD_Intermerge_Tests_Succeeded,
      "GSD Intermerge" },
    { kPOVList_Stat_GSDInterunionTest,  Ray_GSD_Interunion_Tests, Ray_GSD_Interunion_Tests_Succeeded,
      "GSD Interunion" },
