...
bool Lemon::All_Intersections (const Ray& ray, IStack& Depth_Stack, TraceThreadData *Thread) const
{
...
void Lemon::Normal (Vector3d& geometricNormal, Vector3d& smoothNormal, Intersection *Inter, TraceThreadData *Thread) const
{
