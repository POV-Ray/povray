...
enum TokenId : int
{
    ...
    FLOAT_TOKEN,
    FLOOR_TOKEN,
    GET_NORMAL_COUNT_TOKEN,
    GET_TRIANGLE_COUNT_TOKEN,
    GET_UV_COUNT_TOKEN,
    GET_VERTEX_COUNT_TOKEN,
    INSIDE_TOKEN,
    INT_TOKEN,
    ...
    CAMERA_DIRECTION_TOKEN,
    CAMERA_LOCATION_TOKEN,
    CAMERA_RIGHT_TOKEN,
    CAMERA_UP_TOKEN,
    GET_NORMAL_INDICES_TOKEN,
    GET_NORMAL_TOKEN,
    GET_UV_INDICES_TOKEN,
    GET_UV_TOKEN,
    GET_VERTEX_INDICES_TOKEN,
    GET_VERTEX_TOKEN,
    MAX_EXTENT_TOKEN,
    MIN_EXTENT_TOKEN,
    TRACE_TOKEN,
    ...
    FINISH_ID_TOKEN,
    FISHEYE_TOKEN,
    FISHEYE_EQUISOLIDANGLE_TOKEN,
    FISHEYE_ORTHOGRAPHIC_TOKEN,
    FISHEYE_STEREOGRAPHIC_TOKEN,
    FIXED_TOKEN,
    FLATNESS_TOKEN,
    FLIP_TOKEN,
    FOCAL_POINT_TOKEN,
    ...
    LAMBDA_TOKEN,
    LAMBERTAZIMUTHAL_TOKEN,
    LAMBERTCYLINDRICAL_TOKEN,
    LATHE_TOKEN,
    LEFT_ANGLE_TOKEN,
    LEFT_CURLY_TOKEN,
    LEFT_PAREN_TOKEN,
