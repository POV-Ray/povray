...
const RESERVED_WORD Reserved_Words[] = {
    ...
    { FISHEYE_EQUISOLIDANGLE_TOKEN, "fisheye_equisolid_angle" },
    { FISHEYE_ORTHOGRAPHIC_TOKEN,   "fisheye_orthographic" },
    { FISHEYE_STEREOGRAPHIC_TOKEN,  "fisheye_stereographic" },
    { FIXED_TOKEN,                  "fixed" },
    ...
    { GET_NORMAL_COUNT_TOKEN,       "get_normal_count" },
    { GET_NORMAL_INDICES_TOKEN,     "get_normal_indices" },
    { GET_NORMAL_TOKEN,             "get_normal" },
    { GET_TRIANGLE_COUNT_TOKEN,     "get_triangle_count" },
    { GET_UV_COUNT_TOKEN,           "get_uv_count" },
    { GET_UV_INDICES_TOKEN,         "get_uv_indices" },
    { GET_UV_TOKEN,                 "get_uv" },
    { GET_VERTEX_COUNT_TOKEN,       "get_vertex_count" },
    ...
    { OFFSET_TOKEN,                 "offset" },
    { OMEGA_TOKEN,                  "omega" },
    { OMNI_DIRECTIONAL_STEREO_TOKEN,"omni_directional_stereo" },
    ...
    { RANGE_TOKEN,                  "range" },
    { RATIO_TOKEN,                  "ratio" },
    { RATIONAL_BEZIER_PATCH_TOKEN,  "rational_bezier_patch" },
    { READ_TOKEN,                   "read" },
