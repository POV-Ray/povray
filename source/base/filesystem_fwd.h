//******************************************************************************
///
/// @file base/filesystem_fwd.h
///
/// Forward declarations related to file system services.
///
/// @copyright
/// @parblock
///
...
class TemporaryFile;
using TemporaryFilePtr = std::shared_ptr<TemporaryFile>;
...
#endif // POVRAY_BASE_FILESYSTEM_FWD_H
