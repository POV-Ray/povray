...
void PreWriteFrame(OStream *file, const Animation::WriteOptions& options, std::vector<std::string>& warnings, void *state);
void PostWriteFrame(OStream *file, POV_OFF_T bytes, const Animation::WriteOptions& options, std::vector<std::string>& warnings, void *state);
