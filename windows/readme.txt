...
For optimum performance, we generally recommend using Visual Studio 2015
(Community Edition will suffice).

We currently do not provide dedicated Visual Studio 2015 project files.
Instead, simply load and auto-convert the Visual Studio 2010 projects
located in the "windows/vs10" subdirectory.
...
environment variable |PlatformToolset| set to |v140_xp|. However, it has been
reported that binaries built in this manner exhibit unexpected behaviour, and
to generate XP-compatible binaries we recommend using VS 2010 instead.

Visual Studio 2010 and 2012
---------------------------

To build POV-Ray binaries with Visual Studio 2010, you will need a full
version of Visual Studio and the compilers provided with it or with the
platform SDK. Visual Studio 2012 has not been tested in a while, but should
still work as well.
