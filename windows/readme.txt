...
version of POV-Ray is via the provided Visual Studio 2010 project (you
...
That said, we will - time permitting - endeavour to assist express
edition users in building 32-bit versions of POV-Ray, but make no
promises. We do not recommend that express edition users attempt to
build a 64-bit executable as the requisite compilers are not supplied
with VSE (at least, not as of VS2010).
...
*Note:* The editor DLL's are /not/ required for POVWIN to work. If they
...
===========
 ...
 2. Open |windows\vs10\povray.sln| in Visual Studio 2010/2012. Set
    ...
    *Note:* The windows console project is intended to be a simple
    ...
    POV-Ray with /minimal code/. It is */not/* intended to be a
...
|sizeof(ptrdiff_t)| added to the /end/ of the block. This is then
...
In either case, be sure to read through vfesession.h
<../vfe/vfesession.h>; it is heavily commented and is intended to be the
